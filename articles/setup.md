...
`googleLanguageR` contains functions for analysing language through the
...
> Google Cloud Speech API enables you to convert audio to text by
> applying neural network models in an easy to use API. The API
...
4.  [Generate a service account
    ...
    as a JSON file
5.  Return to R, and install this library via
